...
@Component
public class ApprovalHistoryOrderErrorProvider implements ApprovalErrorProvider{
    @Override
    ...
    public String getMessageCode(ApprovalMasterEnum status) {
       return switch(status) {
            case PENDING -> "approval.history.last.pending.not.create.update.order";
            case APPROVED -> "approval.history.last.approved.not.create.update.order";
            case REJECTED -> "approval.history.last.rejected.not.create.update.order";
            case NEEDS_ADJUSTMENT -> "approval.history.last.needsAdjustment.not.create.update.order";
            case ADJUSTMENT -> "approval.history.last.adjustment.not.create.update.order";
            case FINISHED_ADJUSTMENT -> "approval.history.last.finishedAdjustment.not.create.update.order";
        }; 
    }
