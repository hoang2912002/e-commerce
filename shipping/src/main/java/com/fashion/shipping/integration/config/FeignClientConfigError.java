package com.fashion.shipping.integration.config;
...
public class FeignClientConfigError implements ErrorDecoder{
    ...
    public Exception decode(String methodKey, Response response) {
        ...
        try (InputStream body = response.body().asInputStream()) {
            ...
            log.error("SHIPPING-SERVICE call Feign failed: {} - {}", methodKey, errorRes.getErrorCode());
            ...
            return new ServiceException(EnumError.SHIPPING_INTERNAL_ERROR_CALL_API, "server.error.internal");
        }
    }
}
