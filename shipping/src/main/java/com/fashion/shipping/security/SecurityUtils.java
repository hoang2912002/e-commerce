package com.fashion.shipping.security;
...
import com.fashion.shipping.dto.response.UserResponse.UserInsideToken;
...
public class SecurityUtils {
    ...
    public Jwt getUserFromJWTToken(String token) {
        ...
        try {
            ...
            // throw e;
            throw new ServiceException(EnumError.SHIPPING_USER_INVALID_REFRESH_TOKEN, "user.refresh.token.notFormat", Map.of("refresh_token", "wrong"));
        }
    }
