package com.fashion.payment.security;
...
import com.fashion.payment.dto.response.internal.UserResponse.UserInsideToken;
...
public class SecurityUtils {
    ...
    public Jwt getUserFromJWTToken(String token) {
        ...
        try {
            ...
            // throw e;
            throw new ServiceException(EnumError.PAYMENT_USER_INVALID_REFRESH_TOKEN, "user.refresh.token.notFormat", Map.of("refresh_token", "wrong"));
        }
    }
