package com.fashion.inventory.intergration.config;
...
public class FeignClientConfigError implements ErrorDecoder {
    ...
    public Exception decode(String methodKey, Response response) {
        ...
        try (InputStream body = response.body().asInputStream()) {
            ...
            log.error("INVENTORY-SERVICE call Feign failed: {} - {}", methodKey, errorRes.getErrorCode());
            ...
            return new ServiceException(EnumError.INVENTORY_INTERNAL_ERROR_CALL_API, "server.error.internal");
        }
    }
